    ...
    return (
      <Box gridArea={ gridArea }>
        <Flex columnGap={ 2 } textStyle="xs" alignItems="center">
          <span>Made by </span>
          <Link href="phenixtechnology901@gmail.com" target="_blank" display="inline-flex" color={ logoColor } _hover={{ color: logoColor }}>
            Abdul Azeez
          </Link>
        </Flex>
        <Text mt={ 3 } fontSize="xs">
          David Blockchain explorer for Ethereum Networks.
        </Text>
        <Box mt={ 6 } alignItems="start" textStyle="xs">
          <Text>
            Copyright { copy } David Blockchain Limited { (new Date()).getFullYear() }
          </Text>
        </Box>
      </Box>
    );
